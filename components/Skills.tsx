...
const Skills: React.FC = () => {
  ...
  return (
    <section id={SectionId.SKILLS} className="py-12 bg-slate-50 border-t border-slate-200">
      <div className="container mx-auto px-6 md:px-12 max-w-5xl">
        <h3 className="text-3xl font-bold text-slate-900 mb-8">Technical Skills</h3>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {categories.map((category) => (
            <div key={category} className="bg-white p-6 rounded-lg shadow-sm border border-slate-200">
              <h4 className="text-lg font-bold text-primary-600 mb-4 border-b border-slate-100 pb-2">
                {category}
              </h4>
